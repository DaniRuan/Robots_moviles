...
%1 TIEMPO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tf=9;             % Tiempo de simulación en segundos (s)
...
hyd= 13*cos(t) - 5*cos(2*t) - 2*cos(3*t);

%Velocidades de la trayectoria deseada
hxdp= 12*cos(t) - 12*cos(3*t);
hydp= -13 *sin(t) + 10*sin(2*t) + 6*sin(3*t);

%Flor de 9 petalos
%Velocidades de la trayectoria deseada
%r = 4*sin(9*t); % Se declara el radio de la flor
%hxd = 8*(r.*cos(t));
%hyd = 8*(r.*sin(t));
